...
export const books: Book[] = [
  {
    ...
    pages: [
      {
        content: [
          "In this book we will discover how to drag and drop different colors into variables",
      ...
      {
        content: [
          "Here you are able to drag and drop the different colors into the eight different parts of the Hokie Bird.",
      ...
      {
        content: [
          "now, you know how to set color for each part, you can type body part with corresponding color.",
        ],
        image: "HokieBirdActivity",
        props: {
          type: true,
  ...
  },
  {
    ...
    blurb:
      "Learn how to communicate specific instructions to the Hokie Bird to help him find his way!",
    author: "Dev",
    gradeRange: "2-4",
    ...
    pages: [
      {
        content: [
          "The football game is about to start, and HokieBird is very worried because he is lost and doesn't know how to get to Lane Stadium.",
      ...
      {
        content: [
          "Lets try moving the Hokie Bird forward!",
  ...
  },
  {
    ...
    pages: [
      {
        content: [
          "Come to Hand-in-Hand Park in Blacksburg, Virginia.",
      ...
      {
        content: [
          "Look at each corner of the park",
          "How many yellow flowers are there in total in all the corners?",
        ],
        image: "InputActivity",
        game: "InputActivity",
        props: {
      ...
      {
        content: [
          "How many pink flowers are there combined in all the corners?",
        ],
        image: "InputActivity",
        game: "InputActivity",
        props: {
      ...
      },
      {
        content: [
          "Look at each corner of the park",
          "How many yellow trees are there in total in all the corners?",
        ],
        image: "InputActivity",
        game: "InputActivity",
        props: {
      ...
      {
        content: [
          "How many green trees are there combined in all the corners?",
        ],
        image: "InputActivity",
        game: "InputActivity",
        props: {
      ...
      {
        content: [
          "How many pink flowers are there combined on each side of a single yellow tree?",
        ],
        image: "InputActivity",
        game: "InputActivity",
        props: {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        content: [
          "Lets start with dragging and drop statements that should happen if the condition is true!",
  ...
  },
  {
    ...
    pages: [
      {
        content: [
          "We all make different facial expressions based on different emotions.",
  ...
  },
  {
    ...
    pages: [
      {
        content: [
          "HokieBird took an introductory dance technique class this semester,",
      ...
      {
        content: [
          "Nice work! Let's help him memorize another move!",
          "Based on the action numbers you said, HokieBird should make the dance steps that correspond to the numbers.",
          "The appropriate dance steps are:",
          "action1 (bend sideways)",
          "action2 (back kick)",
      ...
      {
        content: [
          "Nice work! Let's help him memorize the final move!",
          "Based on the action numbers you said, HokieBird should make the dance steps that correspond to the numbers.",
          "The appropriate dance steps are:",
          "action1 (bend sideways)",
          "action2 (back kick)",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        props: {
          code:
            "# therapy_dog is the name of the variable (left of '=' sign)\n# and 'Epcot' is the value of the variable (right of '=' sign)\n" +
            "therapy_dog = 'Epcot'\nprint(therapy_dog)\n\n" +
      ...
      },
      {
        ...
        props: {
          code:
            "# Here, number is initially assigned to 10\nnumber = 10\nprint(number)\n\n# Here, number is reassigned to 20\nnumber = 20\n\n" +
      ...
      },
      {
        image: "tutor",
        content: [
          "Here is another example of variable assignment.",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        image: "IntsAndBools",
        content: [
          "This page will focus on Integers and Booleans.",
      ...
      },
      {
        ...
        image: "tutor",
        content: [
          "Take a look at the variables to the left.",
      ...
      },
      {
        ...
        content: [
          "Take a moment to think about his question.",
      ...
      },
      {
        image: "tutor",
        content: [
          "Look that the code to the left.",
  ...
  },
  {
    ...
    pages: [
      {
        image: "/ConditionalOperatorsBook/ConditionalOperatorP1.svg",
        content: [
          "Let's learn about Conditional Operators.",
          "A conditional operator is similar to a math operator(+, -). However, a conditional operator's result is always True or False -- a Boolean!",
      ...
      },
      {
        ...
        content: [
          ...
          "It's best to only use conditional operators on variables of the same data type.",
      ...
      },
      {
        image: "ConditionalOperators",
        content: [
          "Now total_number is also an integer",
          "This means total_number and cream_number are both integers!",
        ],
        props: {
          pageNumber: 5,
        },
      ...
      },
      {
        image: "/ConditionalOperatorsBook/ConditionalOperatorP1.svg",
        content: [
          "Congratulations! You have learned about conditional operators!",
          "Let do a quick a recap!",
          "Conditional operators evaluate to either True or False",
          "Conditional operators should only be used on variables of the same data type.",
    ...
    pages: [
      {
        ...
        content: [
          "In this book, we will learn about another type of operator called a logical operator.",
          ...
          "2. or operator. At least one Boolean is true.",
      ...
      },
      {
        ...
        content: [
          "Like conditional operators, logical operators can only evaluate to True or False.",
          "The next few pages will ask you questions about the different logical operators.",
        ],
        props: {
          pageNumber: 1,
        },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        image: "IfStatements",
        content: [
          "The yellow highlight has been removed from the If-statements, so it's up to you now to notice the indents!",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        image: "LifeOfMoose",
        content: [
          "Moose's breed is 'Labrador Retriever' and his fur has a cream color.",
      ...
      },
      {
        ...
        content: [
          "By 2019, Moose had done something amazing!",
      ...
      },
      {
        image: "MooseDr",
        content: [
          "In 2020, Moose got a very special award.",
      ...
      },
      {
        ...
        content: [
          "Unfortunately, in 2020 Moose was diagnosed with cancer.",
      ...
      },
      {
        image: "MooseThankYou",
        content: [
          "Moose was the first superhero therapy dog at Virginia Tech.",
    ...
    pages: [
      {
        ...
        content: [
          "In this book, we are going to learn how to read flowcharts.",
      ...
      },
      {
        ...
        content: [
          "In October, Virginia Tech held a celebration at Dietrick Lawn for the fall Harvest Festival.",
      ...
      },
      {
        ...
        content: [
          "Imagine you have 2 dollars in your pocket, and really want a yummy donut.",
      ...
      },
      {
        image: "BuyMultiple",
        content: [
          "Now imagine you have $9 in your pocket.",
      ...
      },
      {
        ...
        content: [
          "Let's explore how we can use flowcharts to figure out problems when there's more than one thing to consider!",
      ...
      },
      {
        image: "MultipleConditions",
        content: [
          "Please think carefully first and follow the flowchart to answer the question.",
      ...
      },
      {
        ...
        content: [
          "Imagine you have 16 dollars and then you buy a pepperoni pizza.",
      ...
      },
      {
        ...
        content: [
          "Compare the flowchart you drew with the one on the left to see if they're similar.",
      ...
      },
      {
        ...
        content: [
          "Use the flowchart to help you answer the question on the left.",
      ...
      },
      {
        image: "/FlowchartsBook/Kids_Menu.jpg",
        content: [
          "Congratulations! You now know how to read flowcharts!",
  ...
  },
  {
    BookId: 15,
    title: "Sequencing",
    blurb: "Learn the Sequencing and Algorithims",
    author: "Gabriel H.",
    bookCover: "/color_3.png",
    cover: "/MouseBook/mouse_icon.png",
    gradeRange: "K-2",
    category: BookCategory.BEGINNER,
    pages: [
      {
        image: "/MouseBook/Agorithim Intro Image.png",
        content: [
          "In this book, we are going to learn how algorithims work.",
          "You may be using algorithims everyday and not know it!",
          "Algorithims can help you establish good habits both in coding but also in life.",
          "Algorithims involve having an input, a set of rules or commands to make a certain output.",
        ],
      },
      {
        image: "/MouseBook/Algorithim_Example.png",
        content: [
          "Now lets look at an example where we use basic rules to create an algorithim.",
          "This example involves fixing a lamp!",
          "We start with knowing the lamp doesn't work.",
          "We first check the rule of if the lamp is plugged in.",
          "We determine yes or no and follow down the path that matches.",
          "We then check the rule of if the bulb has burned out.",
          "We determine yes or no and follow down the path that matches.",
          "Based on that we either replace the bulb or buy a new lamp!",
          "Congratulations you've just traced your first algorithim!",
        ],
      },
      {
        image: "/MouseBook/Sequencing.jpeg",
        content: [
          "Now lets talk about Sequencing.",
          "Sequencing is slightly different from Algorithims.",
          "They both have structure that allows for new determinations.",
          "Sequencing, however is much more straight forward and includes less branches.",
          "There are no yes or no determinations. If something happens, it is a fact that some specific action will follow.",
          'We will explore this more in depth with the story of If You give a Mouse A Cookie.',
        ],
      },
      {
        image: "/MouseBook/If you give a mouse a cookie.png",
        content: [
          "Click on the Mouse To see what happens next when you give a mouse a cookie.",
        ],
        props: {
          ans: [
            "Option 1. Make sure to read the explanation!",
