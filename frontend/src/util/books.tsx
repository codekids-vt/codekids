    ...
    pages: [
      {
        ...
        content: ["Let's learn about Conditional Operators.",
      ...
      { // Conditional operators
        ...
        content: ["Test your knowledge about conditional operators!",
      ...
      {
        image: "ConditionalOperators",
        content: ["Now total_number is also an integer",
      ...
      {
        image: "/ConditionalOperatorsBook/ConditionalOperatorP1.svg",
        content: ["Congratulations! You have learned about conditional operators!",
      ...
      [
        {
          ...
          content: ["In this book, we will learn about another type of operator called a logical operator.",
        ...
        { // Logical operators
          ...
          content: ["Like conditional operators, logical operators can only evaluate to True or False.",
        ...
        },
        {
          ...
          content: ["Congratulations! You now know how logical operators work.",
  ...
  },
  {
    ...
    pages:
      [
        ...
        {
          image: "IfStatements",
          content: ["As we have seen, if statements allow you to control the flow of execution based on a condition.",
