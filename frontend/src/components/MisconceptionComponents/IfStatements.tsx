...
export function IfStatements({
  ...
  const p1Code = (
    <p>
      derek_is_happy = <TypeStyle text="True" style={Type.BOOLEAN} />
      <br />
      if derek_is_happy:
      <br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle text='"True"' style={Type.STRING} />)<br />
      else:
      <br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle text='"False"' style={Type.STRING} />)
    </p>
  );

  const p2Code = (
    <p>
      the_weather_is_bad = <TypeStyle text="True" style={Type.BOOLEAN} />
      <br />
      if the_weather_is_bad:
      <br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle
        text='"Gosh, it looks like a rainstorm!"'
        style={Type.STRING}
      />
      )<br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle text='"We have to cancel the game."' style={Type.STRING} />)
      <br />
      else:
      <br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle text={'"Wow, it\'s a beautiful day!"'} style={Type.STRING} />)
      <br />
      <span className="bg-yellow-200 opacity-80">{"\t"}</span>print(
      <TypeStyle
        text={'"Let\'s enjoy the rest of the game!"'}
        style={Type.STRING}
      />
      )<br />
      <br />
      print(
      <TypeStyle
        text={'"Hopefully it\'s sunny tomorrow!"'}
        style={Type.STRING}
      />
      )
    </p>
  ...
  const p3Code = (
    <p>
      anniversary = <TypeStyle text="148" style={Type.INTEGER} />
      <br />
  ...
  const p4Code = (
    <p>
      anniversary = <TypeStyle text="148" style={Type.INTEGER} />
      <br />
      hokie_bird_is_happy = <TypeStyle text="True" style={Type.BOOLEAN} />
      <br />
      if anniversary == <TypeStyle text="200" style={Type.INTEGER} />
      <TypeStyle text=" or" style={Type.BOOLEAN} /> hokie_bird_is_happy:
      <br />
      {"\t"}print(
      <TypeStyle text='"The Hokie Bird is happy!"' style={Type.STRING} />)<br />
      <br />
      print(
      <TypeStyle text={'"Let\'s celebrate!"'} style={Type.STRING} />)
    </p>
  );
