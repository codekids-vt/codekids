...
export function IntsAndBools({
  ...
  props: any | IIntsAndBoolsProps;
  setAllowNext: React.Dispatch<React.SetStateAction<boolean>>;
}) {
  const p2Code = (
    <p>
      hokies_score = <TypeStyle text="38" style={Type.INTEGER} />
      <br />
      syracuse_score = <TypeStyle text="10" style={Type.INTEGER} />
      <br />
      win = hokies_score &gt; syracuse_score
    </p>
  );
        ...
        <div className="mb-5">
          <CodeSnippet
            code={
              <p>
                hokies_score ={" "}
                <TypeStyle text={q1ChosenAnswer} style={dataTypeStyle} />
              </p>
            }
          />
        </div>
