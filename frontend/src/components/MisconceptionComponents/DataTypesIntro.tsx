...
export function DataTypesIntro() {
  const stringCode = (
    <p>
      greeting = <TypeStyle text='"Hello"' style={Type.STRING} />
      <br />
      days_of_week = <TypeStyle text='"7"' style={Type.STRING} />
      <br />
    ...
    <div className="flex flex-col w-full text-center items-center font-semibold text-lg text-center">
      ...
      <div className="flex flex-col-2 m-5 items-center gap-36">
        <CodeSnippet
          code={
            <p>
              jersey_number = <TypeStyle text="25" style={Type.INTEGER} />
            </p>
          }
        />
        <img
          ...
          height={150}
          src="/jersey-25.png"
          alt="Football jersey with number 25"
        />
      </div>
      <Reader text="The variables greeting, days_of_week, and therapy_dog are Strings." />
      <Reader
        text={
          "You can tell they are strings because they are surrounded by double or single quotation marks."
        }
      />
      <div className="flex flex-col-2 m-5 items-center gap-36">
        <img
          ...
          height={200}
          src="/dog_in_box.png"
          alt="Box in representing variable with name therapy_dog"
        />
      ...
      <div className="flex flex-col-2 m-5 items-center gap-36">
        <CodeSnippet
          code={
            <p>
              sky_is_blue = <TypeStyle text="True" style={Type.BOOLEAN} />
            </p>
          }
        />
        <img
