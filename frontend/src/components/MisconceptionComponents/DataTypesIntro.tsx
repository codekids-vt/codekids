    ...
    return(
        <div className='flex flex-col w-full text-center items-center font-semibold text-lg text-center'>
            ...
            <div className='flex flex-col-2 m-5 items-center gap-36'>
                ...
                <img width={150} height={150} src='/jersey-25.png' alt="Football jersey with number 25" />
            </div>
            ...
            <div className='flex flex-col-2 m-5 items-center gap-36'>
                <img width={200} height={200} src='/dog_in_box.png' alt="Box in representing variable with name therapy_dog" />
            ...
            <div className='flex flex-col-2 m-5 items-center gap-36'>
                ...
                <img width={200} height={200} src='/VariablesBook/sky-boolean.png' alt="Image of sky show it is True that the sky is blue" />
            </div>
        </div>
    );
