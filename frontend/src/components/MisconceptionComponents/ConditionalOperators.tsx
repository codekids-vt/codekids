...
export function ConditionalOperators({ props, setAllowNext }: { props: any | IConditionalOperatorsProps, setAllowNext: React.Dispatch<React.SetStateAction<boolean>> }) {
  ...
  const image = <img width={300} height={300} src={'/IfStatementsBook/therapy_dog_1.png'} alt="Therapy dogs with their names."/>
  ...
  const p5Code = <p>
                  black_number = <TypeStyle text='1' style={Type.INTEGER}/><br/>
                  cream_number = <TypeStyle text='2' style={Type.INTEGER}/><br/>
                  total_number == <TypeStyle text="3" style={Type.INTEGER}/><br/>
                  total_number {">"} cream_number = <TypeStyle text={q5ChosenAnswer} style={Type.BOOLEAN}/>
                  </p>
  ...
  function getPage5() {
      return (
          <div className='flex flex-col w-full text-center items-center gap-5'>
              ...
              <MultipleChoiceQuestion question={q5.question} answers={q5.answers} style={Styles.HORIZONTAL} setCorrect={setQ5Correct} buttonPressed={handleQ5}/>
          </div>
      );
  }
