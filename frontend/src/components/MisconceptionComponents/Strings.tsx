...
export function Strings({
  ...
  const p1Code = (
    <p>
      therapy_dog_left = <TypeStyle text='"Derek"' style={Type.STRING} />
      <br />
      therapy_dog_middle = <TypeStyle text="'Epcot'" style={Type.STRING} />
      <br />
  ...
  const p3Code = (
    <p>
      anniversary = <TypeStyle text="147" style={Type.INTEGER} />
      <br />
      {'print("A year has passed!")'}
      <br />
      anniversary_2 = <TypeStyle text='"148"' style={Type.STRING} />
      <br />
      print(
      <TypeStyle text="'anniversary_2'" style={Type.STRING} />)
    </p>
  );
