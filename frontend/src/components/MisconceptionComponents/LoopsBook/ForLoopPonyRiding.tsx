    ...
    return(
        <div className='flex flex-col gap-10 text-center items-center' style={{zoom: windowScale}}>
            <div className='flex gap-5'>
                <img width={500} height={500} src={"/LoopsBook/riding_3.jpg"} alt='Image of people riding pony'/>
                <img width={500} height={500} src={"/LoopsBook/riding_2.jpg"} alt='Image of people riding pony'/>
            </div>
