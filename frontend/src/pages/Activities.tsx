...
export default function ActivityPostList() {
  const otherPostsData = [
    ...
    },
    {
      ...
      author: "Merna",
      blurb:
        "Entering the world of coding could be the greatest choice of your life. See how embarking on coding adventures changed how Casey and Alex view the world!",
