    ...
    <div className="flex flex-col flex-grow items-center w-full h-full">
      ...
      {editing &&
        <Editor
          ...
          padding={10}
        style={{ fontFamily: '"Fira code", "Fira Mono", "monospace"', scale: scale, transformOrigin: "top left" }}
      ...
      <div className="p-2 flex flex-row justify-center items-center space-x-4">
        ...
        {!editing &&
          <div className="flex flex-row justify-center items-center font-bold text-white">
            <div className="bg-primary-green rounded-l-full py-2 px-4 hover:shadow-2xl ">Zoom</div>
            <button onClick={() => setScale(scale * 1.2)} className=" p-2 border-x-2 border-white bg-primary-green">+</button>
            <button onClick={() => setScale(scale / 1.2)} className=" p-2 rounded-r-full border-white bg-primary-green">-</button>
          </div>
        }
